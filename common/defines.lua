...
NCountry = {
	...
	HRE_RANK = 3,								-- Emperor of the HME is displayed as this rank (for ruler title only)
	HRE_MAX_RANK = 1,							-- for members
	HRE_MAX_RANK_ELECTOR = 2,					-- for electors
	HRE_INCIDENT_DAYS_ACTIVE = 365,				-- Number of days HME incidents will be active
...
NAI = {
	...
	HRE_FORCE_JOIN_DESIRE_PER_MISSING_PRINCE = 3.0, --Multiplicative factor per HME missing prince for the purpose of calculating the desire of use the force join HME treaty.
	HRE_FORCE_JOIN_BASE_DESIRE = 5.0, --Base desire for force join HME treaty.
	...
	PEACE_TERMS_PROVINCE_HRE_UNJUSTIFIED_MULT = 0, -- AI desire for a province is multiplied by this for HME provinces if they are a member of the empire and don't have a CB, claim or core to it
	...
	PEACE_TERMS_RELEASE_VASSAL_HRE_MULT = 2.0, -- AI desire for releasing a vassal is multiplied by this if both are HME members
	...
	PEACE_TERMS_TRANSFER_VASSAL_HRE_MULT = 2.0, -- AI desire for releasing a vassal is multiplied by this if both are HME members
	...
	PEACE_TERMS_RELEASE_ANNEXED_HRE_MULT = 2.0, -- AI desire for releasing a country is multiplied by this if both are HME members
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_HRE_EMPEROR_FACTOR = 0.5, -- AI scoring for fabricating claims if province is HME and they are emperor (does not stack with the above penalty)
...
NNationDesigner = {
	...
	MEMBER_OF_HRE_COST = 20,				-- Cost for being part of the HME (base)
	MEMBER_OF_HRE_PROVINCE_COST = 0.2,		-- Cost for being part of the HME (extra cost multiplier on provinces)
